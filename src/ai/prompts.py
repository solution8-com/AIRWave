...
Provide EACH text field in BOTH English. Use the following key naming convention:
- title_en
- whats_new_en
- why_it_matters_en 
- key_details_en
...
Respond with valid JSON only. Each _en field must be in English;. Every field MUST be at least one complete sentence (except community_discussion fields when no comments exist):
{{
